...
public:
	TankEnemy();
	TankEnemy(vec3 pos, GameObject* ref, float m_worldWidth, Color color1, Color color2);
	~TankEnemy();

	void SpawnNewTankEnemy(vec3 pos, GameObject * ref, float m_worldWidth, Color color1, Color color2);
